  ...
  return (
    <div className="fixed top-0 left-0 z-[999999999] w-full h-full flex items-center justify-center ">
      ...
      <div className="modal bg-white bg-opacity-50 z-10  w-full h-full  rounded-lg shadow-lg">
        <button
          className="animated_boxShadow z-[9999999999] modal-close absolute shadow-lg bottom-[40%] bg-white rounded-full p-2 right-12 hover:bg-[#5CD2E6] hover:text-white text-[#5CD2E6] "
          onClick={onClose}
        >
