...
const Modal = ({ isOpen, onClose, children }) => {
  return (
    <div className="fixed top-0  left-0 z-[999999999] w-screen h-screen flex items-center justify-center ">
      ...
      <div className="modal bg-white bg-opacity-50 z-10  w-full h-full  rounded-lg shadow-lg">
        <button
          className="modal-close absolute top-5 right-10 text-purple-600 hover:text-purple-900"
          onClick={onClose}
        >
