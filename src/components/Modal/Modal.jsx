  ...
  return (
    <div className="fixed top-0 left-0 z-[999999999] w-full h-full flex items-center justify-center ">
      ...
      <div className="modal bg-white bg-opacity-50 z-10  w-full h-full  rounded-lg shadow-lg">
        <button
          className="animated_boxShadow modal-close absolute shadow-lg bottom-[50%] bg-white rounded-full p-2 right-5 hover:bg-purple-600 hover:text-white text-purple-600 "
          onClick={onClose}
        >
